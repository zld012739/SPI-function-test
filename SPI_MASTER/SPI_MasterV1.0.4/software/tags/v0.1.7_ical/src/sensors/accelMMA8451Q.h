 ...
 * @section DESCRIPTION
 *
 * MMA8451, triple axis, I2C interface, accelerometer.
...
#define MMA8451_STATUS_ERROR   0x80 // Previous X, Y, or Z data was overwritten by new X, Y, or Z data before it was read
...
#define MMA8451_I2C_ADDR       (MMA8451_I2C_BASE << 1)
