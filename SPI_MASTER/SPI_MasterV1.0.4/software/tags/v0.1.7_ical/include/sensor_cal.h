...
extern void search1DTable(LUTinOutStruct *myTableInOut, genericLUTStruct *myLUT); 
...
extern void orientSensors(void) ;
extern void rpyAlignOffsetComp(double *vector);
extern BOOL calcExtMagInstallAngles(double  *ExtAccels, double  *AHRSattitude, double *angleOfi);
...
extern void remotemag_preProcessing(void);
