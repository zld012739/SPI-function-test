/*****************************************************************************
* File name:  calc_airData.h
*
* File description: 
*   -header file for the file "calc_AirData.c"
*
* $Rev: 17465 $
...
enum { 
     ...
     CALTI,PALTI,DALTI,
     ALTIRATE, OATC, 
     SLIPSKID,MACH, AIRSPEEDRATE,
     UNFILTERED_VS,ALTIRATE_F,
...
#define OAT_LOW_DEGREE_C_LIMIT             -55.0  /*degree C*/
#define OAT_HIGH_DEGREE_C_LIMIT            90.0   /*degree C*/
...
extern uint16_t lastLUTRstIndexB[N_TABLES_B + 1]; 
extern uint16_t lastLUTRstIndexC[N_TABLES_C + 1];
