 ...
 ** parameters:   c - character of interest
 ** Returned value: the character of interest (lowercase if it was upper)
 *****************************************************************************/
 ...
 **
 ** parameters:   two strings to be compared (a and b)
 ** Returned value: strcmp returns 0 when the strings are equal, a negative
 ...
 ** Descriptions:  replace a character inside a string, for example to
 **   replace newline characters with string termination characters.
 **
 ** parameters:   string to be modified (str)
 **               character to be replaced (find)
 **               replacement character (rep)
 ** Returned value: None.
*****************************************************************************/
void strrep(char *str, const char find, const char rep) {
	while (*str) {
		if (find == *str) {
			*str = rep;
		}
 ...
 **               token to use for separation
 **               cursor points to the last found token
 ** Returned value: returns the next token to be used.
*****************************************************************************/
char* strtok_r(char *str, char const token, char **cursor) {
	char *first;
	char *last;
