...
#define NUM_CONFIG_FIELDS					(UPPER_CONFIG_ADDR_BOUND - LOWER_CONFIG_ADDR_BOUND)
...
extern uint16_t appendDownRate (char *response, uint16_t index) ;
extern uint16_t appendAccels (char *response, uint16_t index) ;
extern uint16_t appendAirDataSolution (char *response, uint16_t index);
extern uint16_t appendAirSpeedRate (char *response, uint16_t index) ;
extern uint16_t appendBaroCorrection (char *response, uint16_t index) ;
extern uint16_t appendAirDataSensor (char *response, uint16_t index) ;
...
extern uint16_t appendAirDataSensorCounts (char *response, uint16_t index) ;
extern uint16_t appendAirDataTemp (char *response, uint16_t index);
extern uint16_t appendBodyLoLaNaccels (char *response, uint16_t index);
