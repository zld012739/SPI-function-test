...
$Source: C:\\RCS\\D\\Pumpkin\\Salvo\\Inc\\IARARM\\salvoportiararm.h,v $
$Author: aek $
$Revision: 3.5 $
$Date: 2008-06-05 18:27:51-07 $

Porting file for IAR EWARM tools and ARM7/TDMI.
...
1. OSDispatch() and OSCtxSw() are in portkcarm.asm
