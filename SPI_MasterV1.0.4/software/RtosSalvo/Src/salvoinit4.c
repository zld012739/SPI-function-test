...
$Source: C:\\RCS\\D\\Pumpkin\\Salvo\\Src\\salvoinit4.c,v $
$Author: aek $
$Revision: 3.6 $
...
This functions are required because HiTech PIC-C's memset()
...
{
  OStypeInt8u n;
  OStypeCharEcbP charP;


  n = sizeof(OStypeEcb);
  charP = (OStypeCharEcbP) ecbP;

  while(n--) {
    *charP++ = '\0';
  }
}
#endif /* #if OSENABLE_EVENTS */
